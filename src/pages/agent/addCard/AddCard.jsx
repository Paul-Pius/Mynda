    ...
    return (
        ...
        <div className="container-addcard">
            ...
            {submitted && valid ? <div className="success-message">Success!</div> : null}
                ...
                <div class="cancel" style={{border: "1px solid rgba(212, 211, 211, 0.5)", background: "#FFFFFF", width: "100px", marginLeft: "8rem", marginTop: "1.5rem", height: "2rem", cursor: "pointer"}}>
